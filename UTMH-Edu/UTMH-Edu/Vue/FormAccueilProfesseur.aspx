<%@ Page Title="" Language="C#" MasterPageFile="~/Vue/AccueilProfesseur.Master" AutoEventWireup="true" CodeBehind="FormAccueilProfesseur.aspx.cs" Inherits="UTMH_Edu.Vue.FormAccueilProfesseur" %>
 ...
 <div class="col-lg-7 mb-lg-0 mb-4">
  <div class="card z-index-2 h-100">
    ...
    <div class="card-body p-3">
     ...
     <asp:HiddenField ID="hiddenLabels" runat="server" />
<asp:HiddenField ID="hiddenValues" runat="server" />
</div>
            ...
            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <span class="text-xs font-weight-bold">
                            <asp:Label ID="lbCin" runat="server" Text="..."></asp:Label>
                        </span>
                    </div>
                </div>
            </li>
             ...
             <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm">Cours Enseigner</h6>
                        <span class="text-xs font-weight-bold">
                            <asp:Label ID="lbNomCoursEnseigner" runat="server" Text="..."></asp:Label>
                        </span>
                    </div>
                </div>
            </li>               
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const labels = [<%= hiddenLabels.Value %>];
