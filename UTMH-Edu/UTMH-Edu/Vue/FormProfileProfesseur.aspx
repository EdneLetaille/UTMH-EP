<%@ Page Title="" Language="C#" MasterPageFile="~/Vue/AccueilProfesseur.Master" AutoEventWireup="true" CodeBehind="FormProfileProfesseur.aspx.cs" Inherits="UTMH_Edu.Vue.FormProfileProfesseur" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="font-weight-bolder text-white mb-0">Profil Professeur</h6>
                </nav>
            </div>
        </nav>
        ...
        <div class="container-fluid py-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="profile-header">
                                ...
                                <div class="avatar-wrap">
                                    <asp:Image ID="imgProf" runat="server" CssClass="avatar-img" ImageUrl="~/uploads/default-user.png" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtSalaire" class="form-control" runat="server" TextMode="Number" ReadOnly="True"></asp:TextBox>
                                    </div>
                                </div>                      

                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Date Embauche</label>
                                        <asp:TextBox ID="txtDateEmbauche" class="form-control" runat="server" TextMode="Date" ReadOnly="True"></asp:TextBox>
                                    </div>
                                </div>                

                                <div class="col-md-4 d-flex align-items-end">
                                    <a href="FormModifierMotPasseProfesseur.aspx" class="btn btn-dark w-100">
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    const fu = document.getElementById('<%= fuPhotoProfil.ClientID %>');
                    const img = document.getElementById('<%= imgProf.ClientID %>');
