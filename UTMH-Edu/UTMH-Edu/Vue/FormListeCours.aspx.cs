...
{
    public partial class FormListeCours : System.Web.UI.Page
    {
        Log log = new Log();
        ...
        protected void btnRecherche_Click(object sender, EventArgs e)
        {
            ...
            rechercherCours(recherche, statut);
        }
        void rechercherCours(string recherche = "", string statut = "")
        {
            using (SqlConnection con = new SqlConnection(strCon))
            {
                // Requête SQL avec filtre sur statut et recherche
                string chReq = "SELECT code, nom, description,heureDebut,heureFin,coefficient, statut " +
                               "FROM cours " +
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            // URL dossier la
            string url = "FormDossierCours.aspx?code=" + code;
        ...
        void chargerCours()
        {
            ...
            string chReq = "SELECT * from cours order by idCours DESC";
            SqlCommand cmd = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    GridView1.DataBind();
                    Lb2.Text += "<br/><span style='color:red;'>Il n'y a pas de cours.</span>";
                }
            }
            catch (Exception ex)
            {
