<%@ Page Title="" Language="C#" MasterPageFile="~/Vue/AccueilProfesseur.Master" AutoEventWireup="true" CodeBehind="FormVoirPaie.aspx.cs" Inherits="UTMH_Edu.Vue.FormVoirPaie" %>
        ...
        <div class="col-12">
            <div class="card mb-4 ms-3">
                ...
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    <h6 class="mb-0">Mes paiements (par mois)</h6>
                ...
                <div class="card-body px-3 pt-3 pb-2">
                    ...
                    <div class="table-responsive">
                        <asp:GridView
                            ...
                            OnRowDataBound="gvPaie_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DatePaiement" HeaderText="Date paiement"
                    ...
                    <div class="mt-3">
                        <span class="me-3"><strong>Total payé :</strong> <asp:Label ID="lbTotalPaye" runat="server" Text="0" /></span>
                        <span><strong>Mois payés :</strong> <asp:Label ID="lbMoisPayes" runat="server" Text="0" /></span>
                    </div>
