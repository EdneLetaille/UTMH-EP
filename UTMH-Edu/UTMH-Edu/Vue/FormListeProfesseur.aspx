<%@ Page Title="" Language="C#" MasterPageFile="~/Vue/Accueil.Master" AutoEventWireup="true" CodeBehind="FormListeProfesseur.aspx.cs" Inherits="UTMH_Edu.Vue.FormListeProfesseur" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Liste des professeurs</h6>
                </nav>
                        ...
                        <div class="table-responsive p-0">
                            ...
                            <asp:GridView ID="GridView1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="prenom" HeaderText="prenom" HeaderStyle-ForeColor="Black" SortExpression="prenom" />                                 
                                    <asp:BoundField DataField="email" HeaderText="Email" HeaderStyle-ForeColor="Black" SortExpression="email" />
                                    <asp:BoundField DataField="cin" HeaderText="Cin" HeaderStyle-ForeColor="Black" SortExpression="cin" />


                                     <asp:TemplateField HeaderText="Action" HeaderStyle-ForeColor="Black" >
                                        <ItemTemplate>
                                            <a class="btn btn-sm btn-primary"
                                                href='<%# "FormDossierProfesseur.aspx?code=" + Eval("code") %>'>Voir Plus
                                            </a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
