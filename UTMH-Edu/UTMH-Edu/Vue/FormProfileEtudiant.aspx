<%@ Page Title="" Language="C#" MasterPageFile="~/Vue/AccueilEtudiant.Master" AutoEventWireup="true"
    CodeBehind="FormProfileEtudiant.aspx.cs" Inherits="UTMH_Edu.Vue.FormProfileEtudiant" %>
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="font-weight-bolder text-white mb-0">Profil Étudiant</h6>
                </nav>
            </div>
        </nav>
                ...
                <div class="col-lg-10 col-xl-9 mx-auto">
                    ...
                    <div class="card card-soft">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlSexe" runat="server" CssClass="form-control" Enabled="false">
                            ...
                            <div class="section-title">Contact & Scolarité</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtTelephone" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Option choisie</label>
                                        <asp:DropDownList ID="ddlOption" runat="server" CssClass="form-control" Enabled="false"></asp:DropDownList>
                                    </div>
                                </div>                             
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlAnneeAcademique" runat="server" CssClass="form-control" Enabled="false"></asp:DropDownList>
                                    </div>
                                </div>                            

                                <div class="col-md-4 d-flex align-items-end">
                                    <a href="FormModifierMotPasseEtudiant.aspx" class="btn btn-dark w-100">
