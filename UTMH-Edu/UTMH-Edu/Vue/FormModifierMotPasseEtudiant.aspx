<%@ Page Title="" Language="C#" MasterPageFile="~/Vue/AccueilEtudiant.Master" AutoEventWireup="true"
    CodeBehind="FormModifierMotPasseEtudiant.aspx.cs" Inherits="UTMH_Edu.Vue.FormModifierMotPasseEtudiant" %>
    ...
    <main>
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
                <h6 class="page-title"><asp:Label ID="lbNomComplet" runat="server" Text="..."></asp:Label></h6>
            </div>
        </nav>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="d-none d-md-block">
                                    <span class="badge bg-dark">
                                        <i class="bi bi-shield-lock me-1"></i> Étudiant
                                    </span>
                                </div>
                            </div>
